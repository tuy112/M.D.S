        ...
        <main className={styles.container}>
            ...
            <div className={styles.scoreSpace}>
                <div className={styles.scoreCard}>
                    ...
                    <div className={styles.inning}>7회초 ▲ </div>
            ...
            <div className={styles.buttonArea}>
                <button className={styles.choiceButton} onClick={() => moveSubPage('A')}>A. 마운드 방문 후 이준영 유지</button>
                <button className={styles.choiceButton} onClick={() => moveSubPage('B')}>B. 투수 교체</button>
                <button className={styles.choiceButton} onClick={() => moveSubPage('C')}>C. 고의4구 → 김재환 승부</button>
                <button className={styles.choiceButton} onClick={() => moveSubPage('D')}>D. 수비 강화</button>
            </div>
        </main>
